...
parser.add_argument('--method', default='PN_global_loss', type=str)
parser.add_argument('--network', type=str, default='ResNet12',help='choose which embedding network to use')
...
# ************************************************************
parser.add_argument('--gpu_devices', default='2', type=str)
